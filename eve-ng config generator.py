...
mpls = input('Do you need to enable MPLS? Press R for RSVP, L for LDP, S for SR or N for none.')
...
for net in net_set:
    ...
    # print('node-name octed is:', node_names_digit_octet)
